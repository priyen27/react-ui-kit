...
// Define the props interface for SelectTrigger
interface SelectTriggerProps
  extends React.ComponentPropsWithoutRef<typeof SelectPrimitive.Trigger> {
  customSelectIcon?: React.ReactNode; // Define customSelectIcon prop
}
...
const SelectTrigger = React.forwardRef<
  ...
  SelectTriggerProps
>(({ className, customSelectIcon, children, ...props }, ref) => (
